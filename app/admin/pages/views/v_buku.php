                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Buku.php?act=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Kode Buku <small style="color: red;">* Wajib diisi</small></label>
                                                            <input type="number" class="form-control" value="<?= $row['kodebuku']; ?>" name="kodebuku" required>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-content" style="border-radius: 5px;">
            ...
            <form action="pages/function/Buku.php?act=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Kode Buku <small style="color: red;">* Wajib diisi</small></label>
                        <input type="number" class="form-control" placeholder="Masukan Kode Buku" name="kodebuku" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-block">Simpan</button>
